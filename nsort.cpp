...
static int sort_date_time(struct ffdata *a, struct ffdata *b)
{
   ...
   // if (a64.QuadPart > b64.QuadPart)  return(1) ;
   // else if (a64.QuadPart < b64.QuadPart)  return(-1) ;
   // else 
   //    return(0) ;
...
static int sort_lfn_name_rev(struct ffdata *a, struct ffdata *b)
   {
   return(_strcmpi(b->filename, a->filename)) ;
   }

//*********************************************************
static int sort_ext_rev(struct ffdata *a, struct ffdata *b)
   {
   return(_strcmpi(b->ext, a->ext)) ;
   }
...
static int sort_dir(struct ffdata *a, struct ffdata *b)
   {
   if ((a->dirflag == 'd') && (b->dirflag != 'd'))  return(-1) ;
   else if ((b->dirflag == 'd') && (a->dirflag != 'd'))  return(1) ;
   else return(0) ;
   }
